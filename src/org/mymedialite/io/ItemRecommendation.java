...
public class ItemRecommendation	{
   ...
   * @param user_mapping a user { @link org.mymedialite.data.EntityMapping EntityMapping } object
   * @param item_mapping an item { @link org.mymedialite.data.EntityMapping EntityMapping } object
   * @return a { @link org.mymedialite.data.PosOnlyFeedback PosOnlyFeedback } object with the user-wise collaborative data
   */
  static public IPosOnlyFeedback read(String filename, IEntityMapping user_mapping, EntityMapping item_mapping) throws IOException, NumberFormatException {
   ...
   * @return a { @link org.mymedialite.data.PosOnlyFeedback PosOnlyFeedback } object with the user-wise collaborative data
   */
  static public IPosOnlyFeedback read(BufferedReader reader, IEntityMapping user_mapping, IEntityMapping item_mapping) throws IOException, NumberFormatException {
